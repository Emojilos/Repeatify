    ...
    sections: [
      {
        ...
        formulas: [
          ...
          '$S_{\\triangle} = \\dfrac{1}{2} a \\cdot h_a = \\dfrac{1}{2} a b \\sin C$',
          '$S_{\\triangle} = \\sqrt{p(p-a)(p-b)(p-c)}$ — формула Герона, $p = \\dfrac{a+b+c}{2}$',
          '$S_{\\triangle} = \\dfrac{abc}{4R}$, где $R$ — радиус описанной окружности',
          '$S_{\\triangle} = p \\cdot r$, где $r$ — радиус вписанной окружности',
          ...
          '$S_{\\text{сектор}} = \\dfrac{\\alpha}{360^\\circ} \\pi r^2 = \\dfrac{1}{2} l r$, где $l$ — длина дуги',
        ],
      },
      {
        title: 'Теоремы',
      ...
      },
      {
        ...
        formulas: [
          ...
          'Угол между касательной и хордой = $\\dfrac{1}{2}$ дуги',
          'Касательная перпендикулярна радиусу в точке касания',
          '$|TA|^2 = |TB| \\cdot |TC|$ — свойство касательной и секущей',
        ],
      },
    ],
  },
